...
module.exports = {
  ...
  testsSetup: resolveModule(resolveApp, 'src/setupTests'), //added client
...
module.exports = {
  ...
  appJsConfig: resolveApp('jsconfig.json'),
  yarnLockFile: resolveApp('yarn.lock'),
  testsSetup: resolveModule(resolveApp, 'setupTests'), // changed from src/setupTests because setuptests moved 
  proxySetup: resolveApp('src/setupProxy.js'),
  appNodeModules: resolveApp('node_modules'),
  swSrc: resolveModule(resolveApp, 'src/service-worker'),
  publicUrlOrPath,
